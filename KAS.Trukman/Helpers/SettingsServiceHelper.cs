...
namespace Trukman.Helpers
{
	...
	public static class SettingsServiceHelper
	{
		...
		static string CurrentTripId = "CurrentTripId";
		...
		public static void SaveTripId(string tripId)
		{
			if (settingsService != null)
				settingsService.AddOrUpdateSetting<string> (CurrentTripId, tripId);	
		}

		public static string GetTripId()
		{
			if (settingsService != null)
				return settingsService.GetSetting<string> (CurrentTripId, null);
			else
				return null;
		}
	}
