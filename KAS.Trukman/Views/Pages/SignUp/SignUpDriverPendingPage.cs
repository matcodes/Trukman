...
{
    #region SignUpDriverPendingPage
    public class SignUpDriverPendingPage : TrukmanPage
    {
        public SignUpDriverPendingPage()
            : base()
        {
            this.BindingContext = new SignUpDriverPendingViewModel();
        }
        ...
        public new SignUpDriverPendingViewModel ViewModel
        {
            get { return (this.BindingContext as SignUpDriverPendingViewModel); }
        }
    }
    #endregion
}
