...
{
    #region SignUpUserAuthorizedPage
    public class SignUpUserAuthorizedPage : TrukmanPage
    {
        public SignUpUserAuthorizedPage() : base()
        {
            this.BindingContext = new SignUpUserAuthorizedViewModel();
        }
        ...
        public new SignUpUserAuthorizedViewModel ViewModel
        {
            get { return (this.BindingContext as SignUpUserAuthorizedViewModel); }
        }
    }
    #endregion
}
