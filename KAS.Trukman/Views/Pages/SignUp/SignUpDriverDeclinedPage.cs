...
{
    #region SignUpDriverDeclinedPage
    public class SignUpDriverDeclinedPage : TrukmanPage
    {
        public SignUpDriverDeclinedPage()
            : base()
        {
            this.BindingContext = new SignUpDriverDeclinedViewModel();
        }
        ...
        public new SignUpDriverDeclinedViewModel ViewModel
        {
            get { return (this.BindingContext as SignUpDriverDeclinedViewModel); }
        }
    }
    #endregion
}
