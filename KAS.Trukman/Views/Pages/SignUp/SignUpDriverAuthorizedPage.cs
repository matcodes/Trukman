...
{
    #region SignUpDriverAuthorizedPage
    public class SignUpDriverAuthorizedPage : TrukmanPage
    {
        public SignUpDriverAuthorizedPage()
            : base()
        {
            this.BindingContext = new SignUpDriverAuthorizedViewModel();
        }
        ...
        protected override View CreateContent()
        {
            ...
            var lockImage = new Image
            {
                ...
                HeightRequest = 100,
                WidthRequest = 100,
                Source = PlatformHelper.UnlockImageSource
            };
        ...
        public new SignUpDriverAuthorizedViewModel ViewModel
        {
            get { return (this.BindingContext as SignUpDriverAuthorizedViewModel); }
        }
    }
    #endregion
}
