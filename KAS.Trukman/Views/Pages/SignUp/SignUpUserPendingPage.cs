...
{
    #region SignUpUserPendingPage
    public class SignUpUserPendingPage : TrukmanPage
    {
        public SignUpUserPendingPage() : base()
        {
            this.BindingContext = new SignUpUserPendingViewModel();
        }
        ...
        public new SignUpUserPendingViewModel ViewModel
        {
            get { return (this.BindingContext as SignUpUserPendingViewModel); }
        }
    }
    #endregion
}
