...
{
    #region LumperPage
    public class LumperPage : TrukmanPage
    {
        public LumperPage() 
            : base()
        {
            this.BindingContext = new LumperViewModel();
        }
        ...
        protected override View CreateContent()
        {
            ...
            fuelImage.SetBinding(Image.SourceProperty, new Binding("State", BindingMode.OneWay, lumperStateToImageConverter));
        ...
        public new LumperViewModel ViewModel
        {
            get { return (this.BindingContext as LumperViewModel); }
        }
    }
    #endregion
}
