...
{
    #region SignUpDriverDeclinedViewModel
    public class SignUpDriverDeclinedViewModel : PageViewModel
    {
        public SignUpDriverDeclinedViewModel()
            : base()
        {
        ...
        protected override void Localize()
        {
            ...
            this.MessageText = String.Format(AppLanguages.CurrentLanguage.SignUpDriverDeclinedLabel, (this.Company != null ? this.Company.DisplayName : ""));
        }
