...
{
    #region SignUpUserDeclinedViewModel
    public class SignUpUserDeclinedViewModel : PageViewModel
    {
        public SignUpUserDeclinedViewModel() : base()
        {
        ...
        protected override void Localize()
        {
            ...
            this.MessageText = String.Format(AppLanguages.CurrentLanguage.SignUpUserDeclinedLabel, (this.Company != null ? this.Company.DisplayName : ""));
        }
