...
namespace Trukman
{
	public class SignUpCompanyPage : TrukmanPage
	{
		...
		protected override void OnAppearing ()
		{
			...
			(this.Content as Layout).ForceLayout ();
		}
		...
		protected override View CreateContent ()
		{
			...
			userInfoLayout.HorizontalOptions = LayoutOptions.CenterAndExpand;
			...
			contentLayout.Children.Add (relativeLayout);
			...
			pageContent.Children.Add(contentLayout);
